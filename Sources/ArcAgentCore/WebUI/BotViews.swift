...
/// The main bots page with sessions sidebar (left) and chat area (center).
...
/// The left sidebar with sessions (main) and bots (small section at bottom).
public struct SessionSidebar: View {
    ...
    public func render() -> String {
        ...
        <div class="session-sidebar">
          ...
          <!-- Bots section (bottom) -->
          <div class="sidebar-section bots-section">
            <div class="sidebar-header">
              <h3>Bots</h3>
